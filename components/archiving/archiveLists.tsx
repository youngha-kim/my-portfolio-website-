...
const archieveArr: ArchieveArray = [
  {
    ...
    content: ["content sdfsdfsdfsdfsdfsfsdfsdfsdfsdfsdfsdf", "asdadw2ddasd","asdasxzcsa","asdwdqwdkmmefkmq"],
  },
  {
    img: github,
    link: "https://github.com/youngha-kim",
    subtitle: "subtitlesdfsfsdfsdf",
    content: ["constnen tsdfsdfsdfsdfsdfsfsdfsdfsdfsdfsdfsdf", "123123dadasdsazxcz"],
  },
];
    ...
    <>
      <div className="flex justify-around m-auto max-w-2xl mt-8 ">
        {archieveArr.map((element, id) => {
          return (
            <>
              <div key={id} className="border-2 bg-white m-10 p-10 max-h-fit max-w-fit rounded-2xl shadow-2xl ">
                <SingleArchieve
                  img={element.img}
                  link={element.link}
