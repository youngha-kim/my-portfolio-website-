...
const projectArr: ProjectArray = [
  ...
  },
  {
    ...
    mainContent: [
      ...
      " <strong>Websocket</strong> 프로토콜을 사용하여 채팅 및 알림 기능을 구현하면서 <strong>실시간 통신</strong>에 대한 내용을 새로 배웠으며, 이러한 기술을 활용하면 더 다양한 기능을 구현할 수 있다는 기대감을 갖게 되었습니다.",
      " <strong>Geolocation API</strong>와 같은 웹 API를 사용해 보면서, <strong>비동기 처리</strong>가 사용자 경험에 얼마나 중요한 영향을 미치는지 더욱 명확하게 인지할 수 있었습니다. 이는 막연한 지식에서 벗어나 직접 경험을 통해 깨닫게 된 중요한 점이었습니다.",
      " 회원가입과 로그인 기능을 구현하면서, <strong>Oauth</strong>와 <strong>JWT</strong>에 대한 이해도를 보다 깊게 느낄 수 있었습니다. 실제로 이러한 기능을 구현해 보면서, 이들이 어떻게 흘러가고 연계되는지에 대한 이해도가 높아졌습니다. ",
    ],
    subContent: [
      [
        "주요기능",
